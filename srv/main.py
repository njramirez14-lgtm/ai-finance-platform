...
from srv.routers import account, ai, auth, backtest, budget, card, category, demo, entity, holding, liability, markets, news, property as property_router, smart_money, strategy, strategy_cron, subscription, telegram, transaction, vehicle
